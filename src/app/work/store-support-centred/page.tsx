...
/**
 * LAYOUT EXPERIMENT — a duplicate of /work/store-support with one centred
 * reading measure instead of the mixed split / stacked / flow chapters.
 * The question it exists to answer: does losing the sticky heading in the
 * split layout cost more than reading on a single axis gains? Delete this
 * route once that is settled.
 *
...
export const metadata: Metadata = {
  title: "Store associate app (centred reading test) — fix everything that breaks",
  description:
...
export default function StoreSupportPage() {
  ...
  return (
    ...
    >
      ...
      <CaseStudyColumn className="max-w-[46rem]">
