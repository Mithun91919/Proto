...
export const projects: Project[] = [
  ...
  },
  {
    ...
    systemMap: [
      {
        label: "Before",
        detail: "External tools for docs, design and testing, with nothing governing the path between them",
      },
      {
        label: "Intervention",
        detail: "One platform: find a service, design its contract, test it, subscribe \u2014 controls built in",
      },
      {
        label: "After",
  ...
  },
  {
    slug: "store-support",
    number: "04",
    // Named by what it is rather than by either of its product names —
    // the internal one is out under the copy guide, and the public one
